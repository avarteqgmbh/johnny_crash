...
# repository location
set :repository, "git@github.com:avarteqgmbh/johnny_crash.git"
...
set :deploy_to, "/home/user02612024/rails1"
...
namespace :deploy do
  ...
  task :additional_symlink, :roles => :app do
    ...
    run "ln -sf #{shared_path}/config/authentication.yml #{release_path}/config/authentication.yml"
  end
end
...
namespace :railshoster do
  ...
  task :appurl do
    ...
    puts "\nhttp://user02612024-1.ny.railshoster.de"    
    puts "\n"
  end
end
